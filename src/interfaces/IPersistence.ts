interface IPersistence {
  ...
  getQuest(kind?: string, content?: string, hashAddress?: string): Promise<any>;
  ...
  initPool(token0: string, token1: string, startingPrice: number): Promise<any>;
  initWallet(address: string): Promise<any>;
  initRouter(quests: any[], pools: any[]): Promise<any>;
  citeQuest(crossPool: any, citedPool: any, citingPool: any, amount: number): Promise<any>;
}
